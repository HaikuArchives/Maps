		...
		B_TITLED_WINDOW, B_NOT_RESIZABLE | B_QUIT_ON_WINDOW_CLOSE)
{
	...
	BScrollView* resultListScroller = new BScrollView("resultListScroller",
		searchForm->GetSearchResultList(), 0, false, true);

	BLayoutBuilder::Group<>(mapsView, B_VERTICAL, 0)
		.SetInsets(5)
		.Add(resultListScroller)
		.AddGlue(3)
	.End();

	BLayoutBuilder::Group<>(this, B_VERTICAL, 0)
		.SetInsets(0)
		.Add(searchForm->GetSearchBar())
		.Add(mapsView)
	.End();
}
