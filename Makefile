...
LIBS = $(STDCPPLIBS) be bnetapi netservices shared translation tracker network columnlistview tinyxml
...
SYSTEM_INCLUDE_PATHS = /system/develop/headers/private/netservices/
